...
def epoch_saving(epoch, model, fusion_model, prompt_learner, optimizer, filename):
    torch.save({
                    'epoch': epoch,
...
def best_saving(working_dir, epoch, model, fusion_model, prompt_learner, optimizer):
