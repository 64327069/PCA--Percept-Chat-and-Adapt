...
CLIP_VIT_B16_PATH = '/opt/data/private/workplace/tinyVIRAT/weights/ViT-B-16.pt'
...
if __name__ == '__main__':
    model = clip_vit_base_patch16_adapter24x384(num_classes = 26)
    video = torch.randn(8,3,8,224,224).cuda()
    model = model.cuda()
    output = model(video)
    print(output.shape)