...
class VideoRecord(object):
    ...
    @property
    def sam_path(self): 
        sam_path = '/opt/data/private/Data/questionnaire/frames'
...
class Action_DATASETS_MOD(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        segment_indices_sam = self._sample_indices(record.num_frames) if self.random_shift else self._get_val_indices(record.num_frames)
    ...
    def get(self, record, indices_ori, indices_sam):
        ...
        # print(record.label)
        return process_data, process_data_sam, record.label, record.path
...
if __name__ == '__main__':
    ...
    import yaml
    import tqdm
    config = '/opt/data/private/workplace/pipe2/exp_tube/tube_train.yaml'
    ...
    for kkk,(images,sam_images,list_id) in enumerate(train_loader):
