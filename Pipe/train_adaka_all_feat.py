...
def main():
    ...
    train_data = Action_DATASETS_MOD(config.data.train_list,config.data.label_list,num_segments=config.data.num_segments,image_tmpl=config.data.image_tmpl,cls_num=config.data.num_classes,random_shift=config.data.random_shift, transform=transform_train)
    ...
    val_data = Action_DATASETS_MOD(config.data.val_list,config.data.label_list, random_shift=False,num_segments=config.data.num_segments,image_tmpl=config.data.image_tmpl,cls_num=config.data.num_classes, transform=transform_val)
